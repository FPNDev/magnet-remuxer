...
/** Media playlist; its URIs are relative to the playlist's own directory. */
...
/**
 * Master playlist. Its URIs are prefixed with `basePath` (e.g.
 * "<infoHash>/<fileIndex>") because it's served from the server root.
 */
