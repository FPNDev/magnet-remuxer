...
// length in KiB, then the per-torrent job limits to compare.
...
// The movie fixture is about 18 segments long, which is the divisor the
// pieces-per-segment estimate below uses.
section(
...
// Keeps a fixed number of segment requests outstanding, the way a player
// reading ahead does.
