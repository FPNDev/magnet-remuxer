...
// One torrent with two files, so both readers draw on the same budget.
...
// deselect stops webtorrent downloading anything until a read asks for
// it; storeCacheSlots 0 keeps every held piece measurable on disk.
...
// Pieces are torrent-wide, so a file's share is the piece range that
// covers its byte range.
...
// Eviction runs after a piece lands, so the store can sit a piece or
// two over budget at the moment it is measured.
