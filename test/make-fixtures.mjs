...
// Audio codecs that report no stream format until they have decoded a frame
// (DTS and TrueHD, the kind a Blu-ray remux carries), plus one that is copied
...
await ffmpeg([
  ...
  '-ac:a:2',
  '2',
  // Vorbis only because ffmpeg's DTS and TrueHD encoders stop at 5.1, and a
  // source with more channels than we hand a browser has to be covered.
  '-c:a:3',
  'libvorbis',
  '-metadata:s:a:0',
  'language=eng',
